...
function OnBoarding() {
  ...
  // Logo SVG — color adapts to theme
  const LogoIcon = () => (
    <div className="ob-logo" style={{ width: 30, height: 30, borderRadius: 8, background: "linear-gradient(135deg,#7c3aed,#a855f7)", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", flexShrink: 0 }}>
    ...
    <div style={{ fontFamily: "'Instrument Sans',sans-serif", background: T.bg, color: T.text, minHeight: "100vh" }}>
      ...
      <div className="ob-content" style={{ maxWidth: 560, margin: "0 auto", padding: "44px 20px", position: "relative", zIndex: 1 }}>
        ...
        <div className="fade-up" key={onboardStep}>
            ...
            <div style={{ marginTop: 20 }}>
              ...
              <div className="ob-looking-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 8 }}>
                {[{ v: "Collaborator", i: "🤝" }, { v: "Mentor", i: "🎓" }, { v: "Mentee", i: "🌱" }].map(l => (
                  <div key={l.v} className={`look-card ob-look-card ${formData.lookingFor === l.v ? "on" : ""}`} onClick={() => upd("lookingFor", l.v)}>
          ...
          {/* Step 4 */}
          {onboardStep === 4 && <>
            <h2 className="ob-h2" style={{ fontFamily: "'Instrument Serif',serif", fontSize: 28, color: T.text, marginBottom: 6 }}>Looking good, <span style={{ fontStyle: "italic", color: "#a78bfa" }}>{formData.name || "Builder"}</span>!</h2>
            ...
            <div className="card-flat ob-review-card" style={{ padding: 22, marginBottom: 16 }}>
              <div className="ob-review-header" style={{ display: "flex", gap: 14, alignItems: "center", marginBottom: 16, paddingBottom: 16, borderBottom: `1px solid ${T.border}` }}>
                <div style={{ width: 52, height: 52, borderRadius: 14, background: "linear-gradient(135deg,rgba(124,58,237,0.2),rgba(168,85,247,0.1))", border: "2px solid rgba(124,58,237,0.3)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, fontWeight: 700, color: "#c4b5fd", flexShrink: 0 }}>{(formData.name || "?")[0]}</div>
                ...
                {formData.lookingFor && <span style={{ marginLeft: "auto", fontSize: 11, fontWeight: 600, padding: "3px 10px", borderRadius: 99, background: "rgba(124,58,237,0.1)", border: "1px solid rgba(124,58,237,0.25)", color: "#a78bfa", flexShrink: 0 }}>Seeking {formData.lookingFor}</span>}
              </div>
