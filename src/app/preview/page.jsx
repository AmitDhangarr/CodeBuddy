  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link href={"/signup"}>
          <button style={{ ...btn, width: "100%", padding: 13, background: "linear-gradient(135deg,#7c3aed,#a855f7)", color: "white", borderRadius: 13, fontSize: 14, fontWeight: 700, marginBottom: 10, boxShadow: "0 6px 22px rgba(124,58,237,0.38)" }}>
            🚀 Create Free Account
          </button>
        </Link>
        ...
        <Link href={"/signin"}>
          <button style={{ ...btn, width: "100%", padding: 12, background: "transparent", border: `1px solid ${T.cardBorder}`, color: T.text2, borderRadius: 13, fontSize: 14, fontWeight: 600, marginBottom: 16 }}>
  ...
  return (
    <div
      ...
      onMouseEnter={e => {
        ...
        e.currentTarget.style.boxShadow = "0 8px 32px rgba(124,58,237,0.10)";
      }}
      onMouseLeave={e => {
    ...
    >
      ...
      <div style={{ marginBottom: 8, position: "relative", zIndex: 2 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 4 }}>
          {u.skill_have?.map(s => (
            <span key={s} style={{ padding: "3px 9px", borderRadius: 99, fontSize: 10, fontWeight: 600, background: T.skillHaveBg, border: `1px solid ${T.skillHaveBorder}`, color: T.skillHaveText }}>{s}</span>
          ))}
        </div>
      </div>
      <div style={{ marginBottom: 12, position: "relative", zIndex: 2 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 4 }}>
          {u.skillsNeed.map(s => (
            <span key={s} style={{ padding: "3px 9px", borderRadius: 99, fontSize: 10, fontWeight: 600, background: T.skillNeedBg, border: `1px solid ${T.skillNeedBorder}`, color: T.skillNeedText }}>{s}</span>
          ))}
        </div>
      </div>
      ...
      <div style={{ marginBottom: 14, position: "relative", zIndex: 2 }}>
        <span style={{ fontSize: 11, fontWeight: 600, padding: "3px 10px", borderRadius: 99, background: hsla(u.hue, 0.12), border: `1px solid ${hsla(u.hue, 0.25)}`, color: hsl(u.hue) }}>
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0, position: "relative", zIndex: 2 }}>
        ...
        <div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>
          {u.skill_have?.slice(0, 3).map(s => <span key={s} style={{ padding: "2px 8px", borderRadius: 99, fontSize: 10, fontWeight: 600, background: T.skillHaveBg, border: `1px solid ${T.skillHaveBorder}`, color: T.skillHaveText }}>{s}</span>)}
...
export default function DiscoverTab() {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      [data-discover-preview-root] ::-webkit-scrollbar-thumb { background: rgba(128,128,128,0.2); border-radius: 99px; }
  ...
  return (
    ...
    >
      ...
      {/* ── Preview Banner ── */}
      <div style={{ background: T.aiBg, border: `1px solid ${T.aiBorder}`, borderRadius: 14, padding: "11px 16px", marginBottom: 22, display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap", fontSize: 13, color: T.text2 }}>
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <button onClick={() => openAuth("connect")} style={{ ...btn, padding: "7px 16px", background: "linear-gradient(135deg,#7c3aed,#a855f7)", color: "white", borderRadius: 9, fontSize: 12, fontWeight: 700, flexShrink: 0, boxShadow: "0 4px 14px rgba(124,58,237,0.3)" }}>
            Sign Up Free →
          </button>
        </div>
      </div>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 20, alignItems: "center" }}>
        ...
        <button
          onClick={() => openAuth("filter")}
          style={{ ...btn, padding: "8px 13px", borderRadius: 10, fontSize: 12, fontWeight: 600, background: "transparent", border: `1px solid ${T.cardBorder}`, color: T.text3 }}
        >
          ● Online only
        </button>
      </div>
