...
function Lbl({ children }) {
  return (
    <div style={{ fontSize: 9, fontWeight: 700, letterSpacing: "1.2px", textTransform: "uppercase", color: T.text3, marginBottom: 5 }}>
      {children}
    </div>
  );
}
...
// ── Shared button base ────────────────────────────────────────────────────────
const btn = { border: "none", cursor: "pointer", fontFamily: "inherit", transition: "all 0.18s" };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button style={{ ...btn, width: "100%", padding: 12, background: "transparent", border: "1px solid rgba(255,255,255,0.09)", color: T.text2, borderRadius: 13, fontSize: 14, fontWeight: 600, marginBottom: 16 }}>
...
export default function DiscoverTab() {
  ...
  return (
    <div style={{ background: T.bg, minHeight: "100vh", padding: "24px 20px", fontFamily: "'Instrument Sans', sans-serif", boxSizing: "border-box" }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 20, gap: 14, flexWrap: "wrap" }}>
        <div>
          ...
          <h1 style={{ fontFamily: "'Instrument Serif', serif", fontSize: 30, color: T.text, letterSpacing: "-0.8px", lineHeight: 1.1, margin: 0 }}>Discover Builders</h1>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 20, alignItems: "center" }}>
        <div style={{ position: "relative", flex: "1 1 180px", minWidth: 140 }}>
          ...
          <input
            ...
            style={{ background: T.input, border: `1px solid ${T.inputBorder}`, color: T.text2, borderRadius: 11, fontSize: 13, outline: "none", padding: "9px 14px 9px 34px", width: "100%", fontFamily: "inherit", cursor: "pointer", boxSizing: "border-box" }}
          />
        </div>
        {[
          ...
          <select key={label} onClick={() => openAuth("filter")} onChange={e => { e.target.selectedIndex = 0; openAuth("filter"); }}
            style={{ background: T.input, border: `1px solid ${T.inputBorder}`, color: T.text2, padding: "9px 12px", borderRadius: 10, fontSize: 12, fontFamily: "inherit", outline: "none", cursor: "pointer" }}>
